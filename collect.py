...
FIXED_EVENTS = [
    ...
    ('2026-11-26', 'usoff', '미국 추수감사절 휴장',  '한국 장은 정상 · 다음날 아침 미국 숫자는 25일 것'),
    ('2026-11-27', 'us',   '미국 조기 폐장',       '한국시간 새벽 3시 마감'),
    ...
    ('2026-12-24', 'us',   '미국 조기 폐장',       '한국시간 새벽 3시 마감'),
    ('2026-12-25', 'off',  '성탄절 휴장',          '한국 · 미국 모두 휴장'),
